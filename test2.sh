...
cd client
go build
./client -PeersterAddress=127.0.0.1:5000 -command=download -file=file1.txt -nameToStore=file1.txt -ownersID=f98eeff24e2fced1a1336182a3e8775326262914cc4087066d9346431795ccdb -v
cd ..
